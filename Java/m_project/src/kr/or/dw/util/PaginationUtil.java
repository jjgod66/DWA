...
public class PaginationUtil {
	...
	public void setConfig(int page, int countList, int countPage, int totalCount) {
		 ...
		 * countList : 한 페이지당 레코드의 수
		 * countPage : 페이지의 리스트에서 보여줄 페이지 갯수 보통 5 or 10
		 * totalCount : 게시판 테이블의 총 레코드 건수
		 */
		int totalPage = totalCount / countList;	// 전체 나와야 할 페이지의 수
		...
		int startPage = ((page - 1) / countPage) * countPage + 1;	// page에 1을 빼고, 마지막 결과에 1을 더하는 것은 1과 10페이지에서의 문제 때문이다.
