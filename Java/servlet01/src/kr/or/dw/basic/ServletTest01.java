...
public class ServletTest01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 처리한 내용을응답으로 보내기 위해서 PrintWriter 객체를 생성한다.
		...
		out.append("<html>").append("<head>").append("<meta charset='utf-8'>")
		   ...
		   .append("<h1 style='text-align:center; color:red;'>").append("안녕하세요. 첫번째 Servlet 프로그램 입니다.<br>")
		   .append("Server 경로 : " + request.getContextPath()).append("</h1>").append("</body>").append("</html>");
