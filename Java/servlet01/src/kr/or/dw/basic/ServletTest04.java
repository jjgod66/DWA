...
public class ServletTest04 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		/*
		 * Servlet 클래스나 JSP 페이지의 환경에 관한 정보는 ServletContext 인터페이스 타입의 객체를 이용해서 구한다.
		 */
		ServletContext context = this.getServletContext();
		String serverInfo = context.getServerInfo();	// Serverlet이 속한 웹 서버의 종류 구하기
		 ...
		 *  
		 *  JSP 페이지에서는 apllication 이라는 내장 객체변수의 getInitParameter() 메서드를 이용해서 구한다.
		 *  
