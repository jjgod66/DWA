...
public class DateClass {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat sdf2 = new SimpleDateFormat("HH:mm:ss.SSS");		//대문자 H는 24시간을 기준으로한다. 대문자 SSS는 1/1000초 (millisecond)를 나타낸다.
...
//		cal.set(2022, 0, 19);	// 월은 0부터 시작
		...
		int day = cal.get(Calendar.DAY_OF_WEEK);		// 요일 인덱스
