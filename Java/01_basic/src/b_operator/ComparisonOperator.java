...
public class ComparisonOperator {
	...
	public static void main(String[] args) {
		...
		// double을 float 으로 형변환해야 정확하게 비교할 수 있다.
		b = 10.1f == (float)10.1;
		System.out.println(b);
		...
		b = "abc".equals(new String("abc")); // String의 값을 비교하기 위해서는 equals()메서드를 사용한다.
		System.out.println(b);
		...
		// 3.14f와 3.14는 다른가?
		boolean bool3 = 3.14f != 3.14;
		System.out.println(bool3);
		// "남자"와 "여자"는 다른가?
		boolean bool4 = "남자" != "여자";
		System.out.println(bool4);
		boolean bool5 = !"남자".equals("여자");
