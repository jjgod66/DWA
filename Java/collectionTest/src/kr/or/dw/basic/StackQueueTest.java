...
//		System.out.println("peek으로 꺼내온 값 : " + stack.peek());
		 ...
		 * 				peek() ==> 삭제없이 자료를 꺼내온다.
		 * 	*** 스택은 Stack클래스로 구현하여 제공하고 있지만, 큐는 Queue 인터페이스로만 
		 * 		정의해놓았을 뿐, 별도의 클래스를 제공하고 있지 않다.
		 * 		대신 Queue 인터페이스를 구현한 클래스들이 있어서 그 중 하나를 선택해서 사용하면 된다.
		 */
		...
		System.out.println("큐에서 삭제하기 : " + queue.remove("성춘향"));
		System.out.println("현재 queue 값 : " + queue);
	}
