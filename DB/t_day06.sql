-- 실습5
-- users테이블에서 userid 가 brown이 아닌 회원의 userid, usernm, reg_dt, reg_dt가 없다면 오늘 날짜로 
-- 변경하여 조회해주세요.
...
SELECT ename, job, deptno, sal,
	DECODE(job, 'MANAGER', DECODE(deptno, 30, sal * 1.3, sal * 1.1),
				'SALESMAN', sal * 1.05,
				'PRESIDENT', sal * 1.2,
				sal
			) inc_sal
...
-- 실습7
-- 사원들의 입사년도를 보고 올 해에 건강검진 대상자인지 아닌지 조회하는 쿼리
